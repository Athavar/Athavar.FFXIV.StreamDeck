...
namespace Athavar.FFXIV.StreamDeckPlugin.Helper;
...
{
    private static readonly Regex TextPattern = new Regex("(?<Parameter>{\\w+})|(?<AutoTranslate>{t:\\d+:\\d+})", RegexOptions.Compiled);
